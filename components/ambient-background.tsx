...
// 亮／暗各一組雲霧顏色：冷霧青灰（板岩藍灰／鼠尾草綠／淡鋼藍）。
// 刻意壓低彩度——是「霧氣」而非彩虹霓虹，不搶前景內容。
// 暗色版用較深的青灰並調高 alpha，才在近黑底上看得出來。
const PALETTES = {
  light: ["rgba(144,166,178,0.22)", "rgba(174,191,174,0.18)", "rgba(195,204,212,0.16)"],
  dark: ["rgba(60,74,85,0.32)", "rgba(68,82,74,0.28)", "rgba(78,88,96,0.24)"],
};
